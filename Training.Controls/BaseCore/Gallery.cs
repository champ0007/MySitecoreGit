...
namespace Training.Controls.BaseCore
{
    ...
    public class Gallery : WebControl
    {
        ...
        protected override void DoRender(HtmlTextWriter output)
        {
            ...
            // <div id="slides">
            output.AddAttribute(HtmlTextWriterAttribute.Id, slides);
            ...
            if (datasource != null)
            {
                if (datasource.TemplateID == TemplateReferences.Gallery)
                {
                    ...
                    foreach (Item galleryItem in datasource.Children.Where(x => x.TemplateID == TemplateReferences.GalleryItem))
                    {
                        // <div>
                        output.RenderBeginTag(HtmlTextWriterTag.Div);
